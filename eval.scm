...
(define (eval-assingment exp env)
    ...
    (let ((first (car clauses))
      ...
      (if (cond-else-clause? first)
        (if (null? rest)
          ...
          (error "ELSE clause is't last -- CONF->IF" clauses))
...
(define (extend-envrironment vars vals base-env)
...
(define (setup-environmet)
  (let ((initial-env
          (extend-envrironment (primitive-procedure-names)
